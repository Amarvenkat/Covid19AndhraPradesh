...
import com.amar.covid19andhrapradesh.Adapters.MainRecyclerAdapter;
import com.amar.covid19andhrapradesh.CollectionFood.CollectionFoodMain;
import com.amar.covid19andhrapradesh.HealthWorkerAssigning.HealthWorkerAssigning;
import com.amar.covid19andhrapradesh.MigrantLabour.LabourDetails;
import com.amar.covid19andhrapradesh.Orphan.OrphanHome;
import com.amar.covid19andhrapradesh.Unorganizedworker.UnorganizedMain;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        travelcard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.spandana.ap.gov.in//"));
